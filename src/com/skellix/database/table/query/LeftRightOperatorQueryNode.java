...
public abstract class LeftRightOperatorQueryNode extends QueryNode {
	...
	public String generateCode() {
		...
		if (leftNode instanceof NumberQueryNode || leftNode instanceof VariableQueryNode) {
		...
		if (rightNode instanceof NumberQueryNode || rightNode instanceof VariableQueryNode) {
