...
public class NotEqualsQueryNode extends QueryNode {
	
	private QueryNode previousNode;
	private QueryNode nextNode;

	public NotEqualsQueryNode parse(TreeNode replaceNode) throws QueryParseException {
	...
	private NotEqualsQueryNode compare(QueryNode previousNode, QueryNode nextNode) {
