...
public class GreaterThanOrEqualsQueryNode extends QueryNode {

	private QueryNode previousNode;
	private QueryNode nextNode;

	@Override
	public GreaterThanOrEqualsQueryNode parse(TreeNode replaceNode) throws QueryParseException {
	...
	private GreaterThanOrEqualsQueryNode compare(QueryNode previousNode, QueryNode nextNode) {
