...
public class GreaterThanQueryNode extends QueryNode {

	private QueryNode previousNode;
	private QueryNode nextNode;

	@Override
	public GreaterThanQueryNode parse(TreeNode replaceNode) throws QueryParseException {
	...
	private GreaterThanQueryNode compare(QueryNode previousNode, QueryNode nextNode) {
